...
public class PortalTraveller : MonoBehaviour {
    ...
    public virtual void Teleport (Transform fromPortal, Transform toPortal, Vector3 pos, Quaternion rot) {
        ...
        var cloneScale = graphicsObject.transform.localScale;
        graphicsClone.transform.localScale =
            new Vector3(cloneScale.x / deltaScale.x, cloneScale.y / deltaScale.y, cloneScale.z / deltaScale.z);
    }
