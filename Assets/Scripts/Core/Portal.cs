    ...
    void HandleTravellers () {
        ...
        for (int i = 0; i < trackedTravellers.Count; i++) {
            ...
            if (portalSide != portalSideOld) {
                ...
                var curScale = traveller.graphicsObject.transform.localScale;
                var deltaScale = (linkedPortal.transform.localToWorldMatrix * transform.worldToLocalMatrix).lossyScale;
                traveller.graphicsClone.transform.localScale = new Vector3(curScale.x * deltaScale.x, curScale.y * deltaScale.y, curScale.z * deltaScale.z);
